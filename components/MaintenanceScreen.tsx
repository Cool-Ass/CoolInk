    ...
    <main className="relative flex min-h-[100svh] items-center justify-center overflow-hidden bg-ink-black px-6 py-12 text-ink-white">
      ...
      <section className="relative w-full max-w-3xl text-center" aria-labelledby="maintenance-heading">
        ...
        <div className="mb-8 mt-12 flex items-center justify-center gap-3 text-[10px] font-semibold tracking-[0.22em] text-ink-grey">
          <span className="h-px w-8 bg-ink-gold/60" aria-hidden />
          WKRÓTCE ODKRYJESZ WIĘCEJ
          <span className="h-px w-8 bg-ink-gold/60" aria-hidden />
        </div>
        <div className="mx-auto mb-8 flex h-14 w-14 items-center justify-center rounded-full border border-ink-gold/60 text-2xl text-ink-gold shadow-[0_0_45px_rgba(201,154,74,0.16)]" aria-hidden>
          P
        </div>
      </section>
    </main>
