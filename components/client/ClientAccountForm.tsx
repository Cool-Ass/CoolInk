...
export default function ClientAccountForm({ oauthError, returnTo = "/app/portal", preview = false }: { oauthError?: string; returnTo?: string; preview?: boolean }) {
