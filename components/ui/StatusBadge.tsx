...
const styles: Record<string, string> = { requested: "border-amber-400/45 bg-amber-400/10 text-amber-200", awaiting_confirmation: "border-amber-400/45 bg-amber-400/10 text-amber-200", proposed: "border-sky-400/45 bg-sky-400/10 text-sky-200", date_proposed: "border-sky-400/45 bg-sky-400/10 text-sky-200", confirmed: "border-emerald-400/45 bg-emerald-400/10 text-emerald-200", completed: "border-ink-gold/50 bg-ink-gold/10 text-ink-gold", cancelled: "border-ink-white/20 bg-ink-white/5 text-ink-grey", no_show: "border-red-400/45 bg-red-400/10 text-red-200" };
