...
const labels: Record<string, string> = { requested: "Oczekuje", proposed: "Propozycja", confirmed: "Potwierdzona", completed: "Zakończona", cancelled: "Anulowana", no_show: "Nieobecność" };
