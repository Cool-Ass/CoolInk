...
export default async function ClientsPage() {
  ...
  return <div className="flex flex-col gap-8">
    <div className="flex flex-wrap items-center justify-between gap-4"><div><p className="mb-2 text-[13px] font-medium tracking-[.3em] text-ink-gold">CRM</p><h1 className="font-display text-3xl text-ink-white">Klienci i projekty</h1><p className="mt-2 max-w-xl text-sm leading-relaxed text-ink-grey">Centralna baza klientów, projektów, wizyt, wpłat i historii kontaktu.</p></div><NewClientForm /></div>
