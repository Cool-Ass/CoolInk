...
export default async function CalendarPage() {
  ...
  return <div className="flex flex-col gap-5">
    <div className="flex flex-wrap items-center justify-between gap-4"><div><p className="studio-eyebrow">TERMINARZ STUDIA</p><h1 className="studio-page-title">Kalendarz wizyt</h1></div><NewAppointmentForm projects={projects} /></div>
