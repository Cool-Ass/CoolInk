...
export default async function CalendarPage() {
  ...
  return <div className="flex flex-col gap-5">
    <div className="flex flex-wrap items-center justify-between gap-4"><div><p className="mb-1 text-[11px] tracking-[.18em] text-ink-gold">TERMINARZ STUDIA</p><h1 className="font-display text-3xl text-ink-white">Kalendarz wizyt</h1></div><NewAppointmentForm projects={projects} /></div>
