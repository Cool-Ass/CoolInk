...
export default async function MessagesPage() {
  ...
  return <div className="flex flex-col gap-4">
    <header className="flex flex-wrap items-end justify-between gap-3"><div><p className="studio-eyebrow">CENTRUM KOMUNIKACJI</p><h1 className="studio-page-title">Wiadomości</h1><p className="studio-page-description">Jedna skrzynka dla rozmów powiązanych z projektem.</p></div><MessageTemplateManager initial={templates} /></header>
