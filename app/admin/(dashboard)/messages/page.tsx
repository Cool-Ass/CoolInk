...
export default async function MessagesPage() {
  ...
  return <div className="flex flex-col gap-4">
    <header className="flex flex-wrap items-end justify-between gap-3"><div><p className="text-[10px] font-medium tracking-[0.2em] text-ink-gold">CENTRUM KOMUNIKACJI</p><h1 className="mt-1 font-display text-3xl text-ink-white">Wiadomości</h1><p className="mt-1 text-xs text-ink-grey">Jedna skrzynka dla rozmów powiązanych z projektem.</p></div><MessageTemplateManager initial={templates} /></header>
