...
export default async function ClientAppointmentsPage() {
  ...
  const [projects, appointments, blocks, hours, overrides, availableSlots, promotions, events, settings, consents] = await Promise.all([
