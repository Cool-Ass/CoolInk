...
export default async function ClientAppointmentsPage() {
  ...
  const [projects, appointments, blocks, hours, overrides, availableSlots, promotions, events, buffer] = await Promise.all([
    ...
    prisma.promotion.findMany({ where: { active: true, isPublic: true, endsAt: { gte: new Date() } }, select: { id: true, title: true, description: true, badge: true, color: true, startsAt: true, endsAt: true } }),
