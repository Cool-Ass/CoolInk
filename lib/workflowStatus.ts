...
const projectLabels: Record<string, string> = { inquiry: "NOWE ZGŁOSZENIE", reviewing: "W TRAKCIE ANALIZY", awaiting_client: "WYMAGA TWOJEJ ODPOWIEDZI", awaiting_confirmation: "OCZEKUJE NA DECYZJĘ STUDIA", date_proposed: "TERMIN ZAPROPONOWANY", awaiting_deposit: "OCZEKUJE NA ZADATEK", designing: "PROJEKT W PRZYGOTOWANIU", in_progress: "W REALIZACJI", awaiting_next_session: "KOLEJNA SESJA", accepted: "ZAAKCEPTOWANY", scheduled: "ZAPLANOWANY", confirmed: "W REALIZACJI", completed: "ZAKOŃCZONY", cancelled: "ANULOWANY" };
